use winterfell::math::{log2, fields::f128::BaseElement, FieldElement};
...
pub(crate) fn simple_iterative_fft(input_array: Vec<BaseElement>, omega: BaseElement) -> Vec<BaseElement> {
