    ...
    RationalSumcheckProver<B, E, H>
{
    ...
    pub fn generate_proof(&mut self) -> SumcheckProof<B, E, H> {
        ...
        for i in 0..summing_poly_numerator_evals.len() {
            ...
            let g_val = self
                .compute_g_poly_on_val(E::from(self.summing_domain[i]), E::from(summing_poly_eval));
        ...
        fft::interpolate_poly(&mut g_poly, &inv_twiddles_summing_domain);
        fft::interpolate_poly(&mut e_poly, &inv_twiddles_summing_domain);
